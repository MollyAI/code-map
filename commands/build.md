...
- **Phase 2 (semantic, this is you)** — review Phase 1's `raw_structure.json` and `unresolved.json`, then write the final `code-map.json` with one-line descriptions, layer overrides, and entry-point markers.
