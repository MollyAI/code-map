...
export const I18N = {
  en: {
    ...
    flow_loading: "rendering diagram…",
    flow_cdn_failed: "Couldn't load the Mermaid renderer (offline or blocked). Copy the source below into mermaid.live:",
  ...
  zh: {
    ...
    flow_loading: "正在渲染图…",
    flow_cdn_failed: "无法加载 Mermaid 渲染器（离线或被拦截）。可复制下方源码到 mermaid.live 渲染：",
